...
const AnimatedLink = ({
  ...
  return (
    <a
      className={cn(
        "group relative inline-flex w-fit items-center text-white",
        "before:pointer-events-none before:absolute before:left-0 before:top-[1.5em] before:h-[0.05em] before:w-full before:bg-red-500 before:content-['']",
